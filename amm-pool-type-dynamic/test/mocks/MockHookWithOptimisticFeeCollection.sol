...
contract MockHookWithOptimisticFeeCollection {
    ...
    function beforeSwap(SwapContext calldata, HookSwapParams calldata, bytes calldata /*hookData*/ )
        external
        pure
        returns (uint256 fee)
    {
    ...
    function afterSwap(SwapContext calldata, HookSwapParams calldata swapParams, bytes calldata /*hookData*/ )
        external
        returns (uint256)
    {
